...
// import { Music, Gamepad, LogIn } from 'lucide-react';
...
//                     Play custom games based on your Spotify listening history
//                 </p>
//                 <button
//                     onClick={handleSpotifyLogin}
//                     className="bg-green-500 hover:bg-green-600 text-white font-bold py-4 px-8 rounded-full flex items-center justify-center mx-auto gap-2 transition-all"
//                 >
//                   <LogIn size={24} />
//                   Login with Spotify
//                 </button>
...
//                                 Games tailored to your music taste based on your Spotify listening history.
//                                 Challenge yourself with tracks you love!
//                             </CardDescription>
//                         </CardContent>
//                     </Card>
...
//                         <CardContent>
//                             <CardDescription className="text-gray-300">
//                                 Test your music knowledge with various game modes including
//                                 trivia, guess the song, and more!
//                             </CardDescription>
//                         </CardContent>
//                     </Card>
//                 </div>
